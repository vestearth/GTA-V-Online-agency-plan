...
```bash
python scripts/migrate_to_schema_v2.py --input data/weekly_activity_apr2-9.json --franklin-supplement data/sample_franklin_week.json --output data/schema_v2_from_legacy.json
python scripts/generate_michael_report.py --weekly data/schema_v2_example.json
python scripts/generate_franklin_report.py --weekly data/schema_v2_example.json
python scripts/generate_trevor_report.py --weekly data/schema_v2_example.json
python scripts/generate_agent14_report.py --weekly data/schema_v2_example.json
python scripts/generate_lamar_report.py --weekly data/schema_v2_example.json
python scripts/generate_tony_report.py --weekly data/schema_v2_example.json
python scripts/generate_ron_report.py --weekly data/schema_v2_example.json
python scripts/generate_lester_report.py --weekly data/schema_v2_example.json
```
